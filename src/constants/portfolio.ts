...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tagline: "Currently in active development. Details to be revealed soon.",
    problem: "Redacted for now. Check back later for updates.",
    impact: "Working on building a scalable, high-performance solution.",
  ...
  },
  {
    ...
    tagline: "Currently in active development. Details to be revealed soon.",
    problem: "Redacted for now. Check back later for updates.",
    impact: "Architecting a robust data pipeline and machine learning model.",
  ...
  },
  {
    ...
    tagline: "Currently in active development. Details to be revealed soon.",
    problem: "Redacted for now. Check back later for updates.",
    impact: "Designing a beautiful, accessible user interface with modern tech.",
  ...
  },
  {
    ...
    tagline: "Currently in active development. Details to be revealed soon.",
    problem: "Redacted for now. Check back later for updates.",
    impact: "Building high-concurrency microservices for real-time data.",
